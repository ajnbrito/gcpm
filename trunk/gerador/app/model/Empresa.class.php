...
class Empresa
{
    ...
    function __construct( $id_empresa  ,  $fk_id_usuario  ,  $titulo  ,  $texto_texto  ,  $arquivo_arquivo ) { 
    ...
    /** 
     * @method getId_empresa 
     * @return int(11) id_empresa 
     */ 
    ...
    /** 
     * @method setId_empresa} 
     * @param int(11) id_empresa 
     */ 
