...
include_once "../model/NoticiaDAO.class.php"; 
...
{ 
      ...
      case 'insert': 
       { 
          ...
          * Instancia objeto DAO 
           */ 
           $model = new NoticiaDAO(); 
          /** 
           * Setar valores do objeto com valores vindo do form insert 
           */ 
           $model->setId_noticia($_POST['id_noticia']); 
          ...
          */ 
          ...
          { 
            ...
            */ 
           $model->setId_noticia($_SESSION['Pid_noticia']); 
         ...
         /** 
           ...
           */ 
            header("Location: ../view/backend/listNoticia.view.php"); 
        } 
        else 
        { 
            /** 
  ...
  /** 
   ...
   { 
     ...
     */ 
     $model->setId_noticia($_GET['id_noticia']); 
    /** 
  ...
  */ 
   ...
   { 
      ...
      */ 
       $obj = $model->listPk(); 
           $model->setId_noticia($obj->id_noticia); 
        ...
        * Tenta atualizar 
         */ 
         ...
         { 
             ...
             * Redireciona para view correspondente 
             */ 
            header("Location: ../view/backend/updateNoticia.view.php"); 
        } 
         else 
        { 
            /** 
    ...
    */ 
    ...
    { 
      ...
      */ 
      foreach ($_POST['id_noticia'] as $id_Noticia) 
       { 
           /** 
           * seta o valor do ID a ser deletado 
            */ 
           $model->setId_noticia($id_Noticia); 
           /** 
            * Seleciona arquivos para excluir 
           */ 
           $obj = $model->listPk(); 
    ...
    { 
       ...
       */ 
       ...
       /** 
         * Define valores 
         */ 
       if(!$_SESSION['Pid_noticia'])$_SESSION['Pid_noticia'] = $_POST['id_noticiaP']; 
        $model->setId_noticia($_SESSION['Pid_noticia']); 
     ...
     $_SESSION['listPk'] = $model->listPk(); 
       ...
       */ 
       ...
       { 
           ...
           */ 
           header("Location: ../view/backend/detailsNoticia.view.php"); 
       } 
       else 
       { 
          /** 
