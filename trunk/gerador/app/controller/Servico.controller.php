...
include_once "../model/ServicoDAO.class.php"; 
...
{ 
      ...
      case 'insert': 
       { 
          ...
          * Instancia objeto DAO 
           ...
           */ 
           $model->setId_servico($_POST['id_servico']); 
          ...
          */ 
          ...
          { 
            ...
            */ 
           $model->setId_servico($_SESSION['Pid_servico']); 
         ...
         /** 
           ...
           */ 
            header("Location: ../view/backend/listServico.view.php"); 
        } 
        else 
        { 
            /** 
  ...
  /** 
   ...
   { 
     ...
     */ 
     $model->setId_servico($_GET['id_servico']); 
    /** 
  ...
  */ 
   ...
   { 
      ...
      */ 
       $obj = $model->listPk(); 
           $model->setId_servico($obj->id_servico); 
        ...
        * Tenta atualizar 
         */ 
         ...
         { 
             ...
             * Redireciona para view correspondente 
             */ 
            header("Location: ../view/backend/updateServico.view.php"); 
        } 
         else 
        { 
            /** 
    ...
    */ 
    ...
    { 
      ...
      */ 
      foreach ($_POST['id_servico'] as $id_Servico) 
       { 
           /** 
           * seta o valor do ID a ser deletado 
            */ 
           $model->setId_servico($id_Servico); 
           /** 
            * Seleciona arquivos para excluir 
           */ 
           $obj = $model->listPk(); 
    ...
    { 
       ...
       */ 
       ...
       /** 
         * Define valores 
         */ 
       if(!$_SESSION['Pid_servico'])$_SESSION['Pid_servico'] = $_POST['id_servicoP']; 
        $model->setId_servico($_SESSION['Pid_servico']); 
     ...
     $_SESSION['listPk'] = $model->listPk(); 
       ...
       */ 
       ...
       { 
           ...
           */ 
           header("Location: ../view/backend/detailsServico.view.php"); 
       } 
       else 
       { 
          /** 
