                        ...
                        <div class="form">   
                            <form action="../../controller/Evento.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    ...
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_eventoP" id="id_eventoP" value="" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                    ...
                                    <dl>     
                                         ...
                                         <dd><input name="data_dataP" type='text'  id="data_dataP" value=''/><input name='button' class='botaocalendario'  type='button' onclick="displayCalendar(document.forms[0].data_dataP,'dd/mm/yyyy',this) "  value='Calendário'/></dd>     
                                    </dl>     
                                    <dl>   
                                        <dt><label for="titulo">titulo:</label></dt>   
                                        <dd><input type="text" name="tituloP" size="40" />   
                                        </dd>   
                                    </dl>   
                                    <dl>      
                                    <dt><label for="texto_texto">texto_texto:</label></dt>      
                                    <dd><textarea name="texto_textoP" id="texto_textoP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>    
                                         <dt><label for="arquivo_arquivo">Arquivo_arquivo:</label></dt>    
                                         <dd><input type="file" name="arquivo_arquivoP" id="arquivo_arquivoP" /></dd>    
                                    </dl>    
                                <dl class="submit">    
                                <dt><label></label></dt>    
                                <dd>    
