                ...
                <div class="center_content">  
                    ...
                    <?php $Menu = new Menu(); ?>   
                     ...
                     <div class="right_content">  
                       ...
                       <tbody> 
                       <form action="../../controller/Noticia.controller.php" method="POST" name="form" enctype="multipart/form-data" class="niceform" >  
                       ...
                       foreach($_SESSION['listFilter'] as $campo) {  ?>  
                          <tr>  
                              <td><input type="checkbox" name="id_noticia[]" value="<?= $campo['id_noticia'] ?>" /></td>  
                              <td><?= $campo['titulo'] ?></td>  
                              <td><div align="center"><a href="#" onclick="window.open('../../controller/Noticia.controller.php?id_noticia=<?= $campo['id_noticia'] ?>&opcao=details', 'Detalhes', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=200, LEFT=300, WIDTH=670, HEIGHT=320')"><img src="../../lib/images/zoom.png" alt="" title="" border="0" /></a></div></td>  
                              <td><div align="center"><a href="../../controller/Noticia.controller.php?id_noticia=<?= $campo['id_noticia'] ?>&opcao=listPk "><img src="../../lib/images/user_edit.png" alt="" title="" border="0" /></a></div></td>  
                              <td><div align="center"><a href="../../controller/Noticia.controller.php?id_noticia=<?= $campo['id_noticia'] ?>&opcao=delete" class="ask"><img src="../../lib/images/trash.png" alt="" title="" border="0" /></a></div></td>  
                          </tr>  
                       <?php  } ?>  
                       </form>  
                       </tbody>  
                       ...
                       <p></p>  
                       <div align="right">  
                          <a href="insertNoticia.view.php"><img src="../../lib/images/bt-novo.png" alt="" title="" border="0" /></a>  
                          <a href="selectNoticia.view.php"><img src="../../lib/images/bt-pesquisar.png" alt="" title="" border="0" /></a>  
                       ...
                       <?php    
                                  ...
                                  <?php    
                                             ...
                                             {  
                                  ?>   
                                                   <a href="../../controller/Noticia.controller.php?inicio=<?= $i ?>&opcao=listAll"><?= $i+1 ?></a>   
                                  <?php     
                                             }  
                                         }  
                                     }   
                                  ...
                                  <?php  
                                             ...
                                             {  
                                  ?>  
                                                   <a href="../../controller/Noticia.controller.php?inicio=<?= $i ?>&opcao=listFilter"><?= $i+1 ?></a>  
                                  <?php  
                                             }  
                                         }  
                                     }  
