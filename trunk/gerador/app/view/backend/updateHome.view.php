                        ...
                        <div class="form">   
                            <form action="../../controller/Home.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    ...
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_home" id="id_home" value="<?= $_SESSION['listPk']->id_home ?>" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                         ...
                                         <?php    
                                                              ...
                                                              ?>    
                                                                   ...
                                                                   <dl>    
                                                                       ...
                                                                       <dd><a href="../../controller/Home.controller.php?id_home=<?= $_SESSION['listPk']->id_home ?>&opcao=deleteArquivo" class="ask"><img src="../../lib/images/trash.png" alt="" title="" border="0" /></a> Excluir Arquivo</dd>   
                                                                   </dl>    
                                                              <?php    
                                                                   }    
                                                                   else    
