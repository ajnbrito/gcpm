            ...
            <div class="main_content">   
                ...
                <div class="center_content">   
                    ...
                    <div class="right_content">   
                        <div class="form">   
                            <form action="../../controller/Empresa.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    <input type="hidden" name="opcao" value="update" />   
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_empresa" id="id_empresa" value="<?= $_SESSION['listPk']->id_empresa ?>" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                         ...
                                         <?php    
                                                              ...
                                                              ?>    
                                                                   ...
                                                                   <dl>    
                                                                       ...
                                                                       <dd><a href="../../controller/Empresa.controller.php?id_empresa=<?= $_SESSION['listPk']->id_empresa ?>&opcao=deleteArquivo" class="ask"><img src="../../lib/images/trash.png" alt="" title="" border="0" /></a> Excluir Arquivo</dd>   
                                                                   </dl>    
                                                              <?php    
                                                                   }    
                                                                   else    
