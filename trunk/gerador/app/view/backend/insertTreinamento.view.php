                        ...
                        <div class="form">   
                            <form action="../../controller/Treinamento.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    ...
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_treinamento" id="id_treinamento" value="" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                    ...
                                    <dl>   
                                        ...
                                        <dd><input type="text" name="nome" size="40" />   
                                        </dd>   
                                    </dl>   
                                    <dl>      
                                    <dt><label for="texto_sobre">texto_sobre:</label></dt>      
                                    <dd><textarea name="texto_sobre" id="texto_sobre" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_publico_alvo">texto_publico_alvo:</label></dt>      
                                    <dd><textarea name="texto_publico_alvo" id="texto_publico_alvo" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_conteudo">texto_conteudo:</label></dt>      
                                    <dd><textarea name="texto_conteudo" id="texto_conteudo" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_instrutor">texto_instrutor:</label></dt>      
                                    <dd><textarea name="texto_instrutor" id="texto_instrutor" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>   
                                        <dt><label for="numero_vagas">numero_vagas:</label></dt>   
                                        <dd><input type="text" name="numero_vagas" size="40" />   
                                        </dd>   
                                    </dl>   
                                    <dl>      
                                    <dt><label for="texto_locais">texto_locais:</label></dt>      
                                    <dd><textarea name="texto_locais" id="texto_locais" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_proximas_turmas">texto_proximas_turmas:</label></dt>      
                                    <dd><textarea name="texto_proximas_turmas" id="texto_proximas_turmas" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_incompany">texto_incompany:</label></dt>      
                                    <dd><textarea name="texto_incompany" id="texto_incompany" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_informacoes">texto_informacoes:</label></dt>      
                                    <dd><textarea name="texto_informacoes" id="texto_informacoes" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                <dl class="submit">    
                                <dt><label></label></dt>    
                                <dd>    
