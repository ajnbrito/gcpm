                        ...
                        <div class="form">   
                            <form action="../../controller/Parceiro.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    ...
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_parceiro" id="id_parceiro" value="" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                    ...
                                    <dd><textarea name="texto_descricao" id="texto_descricao" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>   
                                        <dt><label for="link">link:</label></dt>   
                                        <dd><input type="text" name="link" size="40" />   
                                        </dd>   
                                    </dl>   
                                    <dl>    
                                         <dt><label for="arquivo_logo">Arquivo_arquivo:</label></dt>    
                                         <dd><input type="file" name="arquivo_logo" id="arquivo_logo" /></dd>    
                                    </dl>    
                                <dl class="submit">    
                                <dt><label></label></dt>    
                                <dd>    
