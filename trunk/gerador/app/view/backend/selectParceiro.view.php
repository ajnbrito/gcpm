                        ...
                        <div class="form">   
                            <form action="../../controller/Parceiro.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    ...
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_parceiroP" id="id_parceiroP" value="" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                    ...
                                    <dd><textarea name="texto_descricaoP" id="texto_descricaoP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>   
                                        <dt><label for="link">link:</label></dt>   
                                        <dd><input type="text" name="linkP" size="40" />   
                                        </dd>   
                                    </dl>   
                                    <dl>    
                                         <dt><label for="arquivo_logo">Arquivo_arquivo:</label></dt>    
                                         <dd><input type="file" name="arquivo_logoP" id="arquivo_logoP" /></dd>    
                                    </dl>    
                                <dl class="submit">    
                                <dt><label></label></dt>    
                                <dd>    
