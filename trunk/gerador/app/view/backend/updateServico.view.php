            ...
            <div class="main_content">   
                ...
                <div class="center_content">   
                    ...
                    <div class="right_content">   
                        <div class="form">   
                            <form action="../../controller/Servico.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    <input type="hidden" name="opcao" value="update" />   
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_servico" id="id_servico" value="<?= $_SESSION['listPk']->id_servico ?>" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                         ...
                                         <?php    
                                                              ...
                                                              ?>    
                                                                   ...
                                                                   <dl>    
                                                                       ...
                                                                       <dd><a href="../../controller/Servico.controller.php?id_servico=<?= $_SESSION['listPk']->id_servico ?>&opcao=deleteArquivo" class="ask"><img src="../../lib/images/trash.png" alt="" title="" border="0" /></a> Excluir Arquivo</dd>   
                                                                   </dl>    
                                                              <?php    
                                                                   }    
                                                                   else    
