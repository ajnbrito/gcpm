...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','850','height','250','src','../..//lib/flash/banner','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../..//lib/flash/banner' ); //end AC code
            ...
            <div  id="nav">
                <ul>
					...
					<li id="current"><a href="noticia.php">notícias</a></li>
            ...
            <div id="content-wrap" class="two-col"  >
              <div id="main2">   
                  ...
                  <?php
                        ...
                        foreach ($_SESSION['list_noticia'] as $noticia)
                        {               
                            echo '<p>';
                            if ($noticia['arquivo_arquivo'])
                            {                                
                                echo "<div id=\"esquerda\"><h1>{$noticia['titulo']}</h1><p>{$noticia['texto_texto']}</p></div>";
                                echo "<div id=\"direita\"><p><img src=\"../../upload/{$noticia['arquivo_arquivo']}\" width=\"150\"></p></div>";
                            }
                            else
                            {                                
                                echo "<div id=\"esquerda2\"><h1>{$noticia['titulo']}</h1><p>{$noticia['texto_texto']}</p></div>";
                            }
                           echo '</p>';
                        }
                    ?>
