...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','850','height','250','src','../..//lib/flash/banner','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../..//lib/flash/banner' ); //end AC code
            ...
            <div  id="nav">
                <ul>
					...
					<li id="current"><a href="parceiro.php">parceiros</a></li>
            ...
            <div id="content-wrap" class="two-col"  >
              <div id="main2">   
                  ...
                  <?php
                        ...
                        {               
                            echo '<p>';
                            if ($parceiro['arquivo_logo'])
                            {                                
                                echo "<div id=\"esquerda\"><h1>{$parceiro['nome']}</h1><p>{$parceiro['texto_descricao']}</p><p><a href='http://{$parceiro['link']}' target='_blank'>{$parceiro['link']}</a></p></div>";
                                echo "<div id=\"direita\"><p><img src=\"../../upload/{$parceiro['arquivo_logo']}\" width=\"150\"></p></div>";
                            }
                            else
                            {                                
                                echo "<div id=\"esquerda2\"><h1>{$parceiro['nome']}</h1><p>{$parceiro['texto_descricao']}</p><p><a href='http://{$parceiro['link']}' target='_blank'>{$parceiro['link']}</a></p></div>";
                            }
                           echo '</p>';
                        }
                    ?>
