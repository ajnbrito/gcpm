        ...
        <div id="wrap">
            ...
            <div id="content-wrap" class="two-col"  >
                <div id="main2">
                    ...
                    {
                        echo '<p>';
                        echo "<div id=\"esquerda2\"><p><a href='treinamentoDetalhe.php?id_treinamento={$treinamento['id_treinamento']}'><h1>{$treinamento['nome']}</h1></a></p><p></p></div>";
                        echo '</p>';
                    }
                    ?>
                </div>
