...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','850','height','250','src','../..//lib/flash/banner','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../..//lib/flash/banner' ); //end AC code
            ...
            <div  id="nav">
                <ul>
					...
					<li id="current"><a href="case.php">case</a></li>					
            ...
            <div id="content-wrap" class="two-col"  >
              <div id="main2">   
                  ...
                  <?php
                        ...
                        foreach ($_SESSION['list_case'] as $case)
                        {               
                            echo '<p>';
                            if ($case['arquivo_arquivo'])
                            {                                
                                echo "<div id=\"esquerda\"><h1>{$case['titulo']}</h1><p>{$case['texto_texto']}</p></div>";
                                echo "<div id=\"direita\"><p><img src=\"../../upload/{$case['arquivo_arquivo']}\" width=\"150\"></p></div>";
                            }
                            else
                            {                                
                                echo "<div id=\"esquerda2\"><h1>{$case['titulo']}</h1><p>{$case['texto_texto']}</p></div>";
                            }
                           echo '</p>';
                        }
                    ?>
