...
var pathToImages = '../../lib/imagens/';	// Relative to your HTML file
...
var selectBoxRolloverBgColor = '#267DA8'; // Background color on drop down lists(rollover)
...
function initCalendar()
{
	if(MSIE){
		...
		iframeObj.style.backgroundColor = '#267DA8';
		//// fix for EI frame problem on time dropdowns 09/30/2006
...
function tooltip() {
	...
	for (i=0; i<links.length; i++) {
		...
		if (title) {
			...
			//links[i].onmouseover = function() { showTip(this.getAttribute("title")+"<br />"); }
		}
