...
include_once "../model/CasesDAO.class.php"; 
...
{ 
      ...
      case 'insert': 
       { 
          ...
          * Instancia objeto DAO 
           ...
           */ 
           $model->setId_cases($_POST['id_cases']); 
          ...
          */ 
          ...
          { 
            ...
            */ 
           $model->setId_cases($_SESSION['Pid_cases']); 
         ...
         /** 
           ...
           */ 
            header("Location: ../view/backend/listCases.view.php"); 
        } 
        else 
        { 
            /** 
  ...
  /** 
   ...
   { 
     ...
     */ 
     $model->setId_cases($_GET['id_cases']); 
    /** 
  ...
  */ 
   ...
   { 
      ...
      */ 
       $obj = $model->listPk(); 
           $model->setId_cases($obj->id_cases); 
        ...
        * Tenta atualizar 
         */ 
         ...
         { 
             ...
             * Redireciona para view correspondente 
             */ 
            header("Location: ../view/backend/updateCases.view.php"); 
        } 
         else 
        { 
            /** 
    ...
    */ 
    ...
    { 
      ...
      */ 
      foreach ($_POST['id_cases'] as $id_Cases) 
       { 
           /** 
           * seta o valor do ID a ser deletado 
            */ 
           $model->setId_cases($id_Cases); 
           /** 
            * Seleciona arquivos para excluir 
           */ 
           $obj = $model->listPk(); 
    ...
    { 
       ...
       */ 
       ...
       /** 
         * Define valores 
         */ 
       if(!$_SESSION['Pid_cases'])$_SESSION['Pid_cases'] = $_POST['id_casesP']; 
        $model->setId_cases($_SESSION['Pid_cases']); 
     ...
     $_SESSION['listPk'] = $model->listPk(); 
       ...
       */ 
       ...
       { 
           ...
           */ 
           header("Location: ../view/backend/detailsCases.view.php"); 
       } 
       else 
       { 
          /** 
