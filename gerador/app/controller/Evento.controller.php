...
include_once "../model/EventoDAO.class.php"; 
...
{ 
      ...
      case 'insert': 
       { 
          ...
          * Instancia objeto DAO 
           ...
           */ 
           $model->setId_evento($_POST['id_evento']); 
           $model->setFk_id_usuario($_POST['fk_id_usuario']); 
           $model->setData_data($_POST['data_data']); 
          ...
          */ 
          ...
          { 
            ...
            */ 
           $model->setId_evento($_SESSION['Pid_evento']); 
           $model->setFk_id_usuario($_SESSION['Pfk_id_usuario']); 
           $model->setData_data($_SESSION['Pdata_data']); 
         ...
         /** 
           ...
           */ 
            header("Location: ../view/backend/listEvento.view.php"); 
        } 
        else 
        { 
            /** 
  ...
  /** 
   ...
   { 
     ...
     */ 
     $model->setId_evento($_GET['id_evento']); 
    /** 
  ...
  */ 
   ...
   { 
      ...
      */ 
       $obj = $model->listPk(); 
           $model->setId_evento($obj->id_evento); 
           $model->setFk_id_usuario($obj->fk_id_usuario); 
           $model->setData_data($obj->data_data); 
        ...
        * Tenta atualizar 
         */ 
         ...
         { 
             ...
             * Redireciona para view correspondente 
             */ 
            header("Location: ../view/backend/updateEvento.view.php"); 
        } 
         else 
        { 
            /** 
    ...
    */ 
    ...
    { 
      ...
      */ 
      foreach ($_POST['id_evento'] as $id_Evento) 
       { 
           /** 
           * seta o valor do ID a ser deletado 
            */ 
           $model->setId_evento($id_Evento); 
           /** 
            * Seleciona arquivos para excluir 
           */ 
           $obj = $model->listPk(); 
    ...
    { 
       ...
       */ 
       ...
       /** 
         * Define valores 
         */ 
       if(!$_SESSION['Pid_evento'])$_SESSION['Pid_evento'] = $_POST['id_eventoP']; 
        $model->setId_evento($_SESSION['Pid_evento']); 
       if(!$_SESSION['Pfk_id_usuario'])$_SESSION['Pfk_id_usuario'] = $_POST['fk_id_usuarioP']; 
        $model->setFk_id_usuario($_SESSION['Pfk_id_usuario']); 
       if(!$_SESSION['Pdata_data'])$_SESSION['Pdata_data'] = $_POST['data_dataP']; 
        $model->setData_data($_SESSION['Pdata_data']); 
     ...
     $_SESSION['listPk'] = $model->listPk(); 
       ...
       */ 
       ...
       { 
           ...
           */ 
           header("Location: ../view/backend/detailsEvento.view.php"); 
       } 
       else 
       { 
          /** 
