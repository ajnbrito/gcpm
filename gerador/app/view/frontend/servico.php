...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0','width','850','height','250','src','../..//lib/flash/banner','quality','high','pluginspage','http://www.macromedia.com/go/getflashplayer','movie','../..//lib/flash/banner' ); //end AC code
            ...
            <div  id="nav">
                <ul>
					...
					<li id="current"><a href="servico.php">servi&Ccedil;os</a></li>			
            ...
            <div id="content-wrap" class="two-col"  >
              <div id="main2">   
                  ...
                  <?php
                        ...
                        {               
                            echo '<p>';
                            if ($servico['arquivo_arquivo'])
                            {                                
                                echo "<div id=\"esquerda\"><h1>{$servico['titulo']}</h1><p>{$servico['texto_texto']}</p><br></div>";
                                echo "<div id=\"direita\"><p><img src=\"../../upload/{$servico['arquivo_arquivo']}\" width=\"150\"></p></div>";
                            }
                            else
                            {                                
                                echo "<div id=\"esquerda2\"><h1>{$servico['titulo']}</h1><p>{$servico['texto_texto']}</p><br></div>";
                            }
                           echo '</p>';
                        }
                    ?>
