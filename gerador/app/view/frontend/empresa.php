            ...
            <div id="content-wrap" class="two-col"  >
              <div id="main2">   
                  ...
                  <?php
                        ...
                        foreach ($_SESSION['list_empresa'] as $empresa)
                        {               
                            echo '<p>';
                            if ($empresa['arquivo_arquivo'])
                            {
                                echo "<div id=\"esquerda\"><h1>{$empresa['titulo']}</h1><p>{$empresa['texto_texto']}</p><br></div>";
                                echo "<div id=\"direita\"><p><img src=\"../../upload/{$empresa['arquivo_arquivo']}\" width=\"150\"></p></div>";
                            }
                            else
                            {
                                echo "<div id=\"esquerda2\"><h1>{$empresa['titulo']}</h1><p>{$empresa['texto_texto']}</p><br></div>";
                            }
                           echo '</p>';
                        }
                    ?>
