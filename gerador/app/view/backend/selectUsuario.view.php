            ...
            <div class="main_content">   
                ...
                <div class="center_content">   
                    ...
                    <div class="right_content">   
                        <div class="form">   
                            <form action="../../controller/Usuario.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    <input type="hidden" name="opcao" value="listFilter" />   
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_usuarioP" id="id_usuarioP" value="" /></dd>   
                                    </dl>   
                                    <dl>   
                                    ...
                                    <dl>   
                                        ...
                                        <dd><input type="text" name="usuarioP" size="40" />   
                                        </dd>   
                                    </dl>   
                                    <dl>   
                                        <dt><label for="senha">senha:</label></dt>   
                                        <dd><input type="text" name="senhaP" size="40" />   
                                        </dd>   
                                    </dl>   
                                <dl class="submit">    
                                <dt><label></label></dt>    
