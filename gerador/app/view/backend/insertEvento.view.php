                        ...
                        <div class="form">   
                            <form action="../../controller/Evento.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    ...
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_evento" id="id_evento" value="" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                    ...
                                    <dl>     
                                         ...
                                         <dd><input name="data_data" type='text'  id="data_data" value=''/><input name='button' class='botaocalendario'  type='button' onclick="displayCalendar(document.forms[0].data_data,'dd/mm/yyyy',this) "  value='Calendário'/></dd>     
                                    </dl>     
                                    <dl>   
