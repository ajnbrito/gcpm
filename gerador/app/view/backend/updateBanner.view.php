            ...
            <div class="main_content">   
                ...
                <div class="center_content">   
                    ...
                    <div class="right_content">   
                        <div class="form">   
                            <form action="../../controller/Banner.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    <input type="hidden" name="opcao" value="update" />   
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_banner" id="id_banner" value="<?= $_SESSION['listPk']->id_banner ?>" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                         ...
                                         <?php    
                                                              ...
                                                              ?>    
                                                                   ...
                                                                   <dl>    
                                                                       ...
                                                                       <dd><a href="../../controller/Banner.controller.php?id_banner=<?= $_SESSION['listPk']->id_banner ?>&opcao=deleteArquivo" class="ask"><img src="../../lib/images/trash.png" alt="" title="" border="0" /></a> Excluir Arquivo</dd>   
                                                                   </dl>    
                                                              <?php    
                                                                   }    
                                                                   else    
