            ...
            <div class="main_content">   
                ...
                <div class="center_content">   
                    ...
                    <div class="right_content">   
                        <div class="form">   
                            <form action="../../controller/Evento.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    <input type="hidden" name="opcao" value="update" />   
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_evento" id="id_evento" value="<?= $_SESSION['listPk']->id_evento ?>" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                    ...
                                    <dl>     
                                         <dt><label for="data_data">data_data:</label></dt>     
                                         <dd><input name="data_data" type='text'  id="data_data" value="<?= $_SESSION['listPk']->data_data ?>"/><input name='button' class='botaocalendario'  type='button' onclick="displayCalendar(document.forms[0].data_data,'dd/mm/yyyy',this) "  value='Calendário'/></dd>     
                                    </dl>     
                                    <dl>   
                                        <dt><label for="titulo">titulo:</label></dt>   
                                        <dd><input type="text" name="titulo" size="40" value="<?= $_SESSION['listPk']->titulo ?>"/>   
                                        </dd>   
                                    </dl>   
                                    <dl>      
                                    <dt><label for="texto_texto">texto_texto:</label></dt>      
                                    <dd><textarea name="texto_texto" id="texto_texto" rows="6" cols="41"><?= $_SESSION['listPk']->texto_texto ?></textarea></dd>      
                                    </dl>      
                                    <dl>    
                                         <?php    
                                                              if($_SESSION['listPk']->arquivo_arquivo);    
                                                              {   
                                                                   $filetype = pathinfo("../../upload/".$_SESSION['listPk']->arquivo_arquivo);   
                                                                   if(strtoupper($filetype['extension']) == "JPG" || strtoupper($filetype['extension']) == "JPEG" || strtoupper($filetype['extension']) == "GIF" || strtoupper($filetype['extension']) == "PNG" || strtoupper($filetype['extension']) == "BMP")   
                                                                   {    
                                                              ?>    
                                                                   <dl>    
                                                                       <dt><label for="arquivo_arquivo">Arquivo:</label></dt>    
                                                                       <dd> <img width="310" src="../../upload/<?= $_SESSION['listPk']->arquivo_arquivo ?>"></dd>   
                                                                   </dl>    
                                                                   <dl>    
                                                                        <dt><input type="hidden" name="arquivo_arquivoOld" value="<?= $_SESSION['listPk']->arquivo_arquivo ?>" /></dt>   
                                                                       <dd><a href="../../controller/Evento.controller.php?id_evento=<?= $_SESSION['listPk']->id_evento ?>&opcao=deleteArquivo" class="ask"><img src="../../lib/images/trash.png" alt="" title="" border="0" /></a> Excluir Arquivo</dd>   
                                                                   </dl>    
                                                              <?php    
                                                                   }    
                                                                   else    
                                                              ...
                                                              ?>    
                                                                   <dl>    
                                                                       <dt><label for="arquivo_arquivo">Arquivo:</label></dt>    
                                                                       <dd> <?= $_SESSION['listPk']->arquivo_arquivo ?></dd>   
                                                                   </dl>    
                                                                   <dl>    
                                                                        <dt><input type="hidden" name="arquivo_arquivoOld" value="<?= $_SESSION['listPk']->arquivo_arquivo ?>" /></dt>   
                                                                       <dd><a href="../../controller/Evento.controller.php?id_evento=<?= $_SESSION['listPk']->id_evento ?>&opcao=deleteArquivo" class="ask"><img src="../../lib/images/trash.png" alt="" title="" border="0" /></a> Excluir Arquivo</dd>   
                                    ...
                                    <dl>   
                                        ...
                                        <dd><input type="file" name="arquivo_arquivo" size="40" value="<?= $_SESSION['listPk']->arquivo_arquivo ?>"/>   
                                        </dd>   
                                    </dl>   
                                    </dl>    
                                <dl class="submit">    
