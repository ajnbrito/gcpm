                    ...
                    <div class="right_content">   
                        <div class="form">   
                            <form action="../../controller/Treinamento.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    <input type="hidden" name="opcao" value="listFilter" />   
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_treinamentoP" id="id_treinamentoP" value="" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="fk_id_usuarioP" id="fk_id_usuarioP" value="<?= $_SESSION['listPk']->fk_id_usuario ?>"/></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt><label for="nome">nome:</label></dt>   
                                        <dd><input type="text" name="nomeP" size="40" />   
                                        </dd>   
                                    </dl>   
                                    <dl>      
                                    <dt><label for="texto_sobre">texto_sobre:</label></dt>      
                                    <dd><textarea name="texto_sobreP" id="texto_sobreP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_publico_alvo">texto_publico_alvo:</label></dt>      
                                    <dd><textarea name="texto_publico_alvoP" id="texto_publico_alvoP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_conteudo">texto_conteudo:</label></dt>      
                                    <dd><textarea name="texto_conteudoP" id="texto_conteudoP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_instrutor">texto_instrutor:</label></dt>      
                                    <dd><textarea name="texto_instrutorP" id="texto_instrutorP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>   
                                        <dt><label for="numero_vagas">numero_vagas:</label></dt>   
                                        <dd><input type="text" name="numero_vagasP" size="40" />   
                                        </dd>   
                                    </dl>   
                                    <dl>      
                                    <dt><label for="texto_locais">texto_locais:</label></dt>      
                                    <dd><textarea name="texto_locaisP" id="texto_locaisP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_proximas_turmas">texto_proximas_turmas:</label></dt>      
                                    <dd><textarea name="texto_proximas_turmasP" id="texto_proximas_turmasP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_incompany">texto_incompany:</label></dt>      
                                    <dd><textarea name="texto_incompanyP" id="texto_incompanyP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                    <dl>      
                                    <dt><label for="texto_informacoes">texto_informacoes:</label></dt>      
                                    <dd><textarea name="texto_informacoesP" id="texto_informacoesP" rows="6" cols="41"></textarea></dd>      
                                    </dl>      
                                <dl class="submit">    
                                <dt><label></label></dt>    
                                <dd>    
