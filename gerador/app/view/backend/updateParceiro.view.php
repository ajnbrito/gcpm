            ...
            <div class="main_content">   
                ...
                <div class="center_content">   
                    ...
                    <div class="right_content">   
                        <div class="form">   
                            <form action="../../controller/Parceiro.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    <input type="hidden" name="opcao" value="update" />   
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_parceiro" id="id_parceiro" value="<?= $_SESSION['listPk']->id_parceiro ?>" /></dd>   
                                    </dl>   
                                    <dl>   
                                        <dt></dt>   
                                    ...
                                    <dl>      
                                    <dt><label for="texto_descricao">texto_descricao:</label></dt>      
                                    <dd><textarea name="texto_descricao" id="texto_descricao" rows="6" cols="41"><?= $_SESSION['listPk']->texto_descricao ?></textarea></dd>      
                                    </dl>      
                                    <dl>   
                                        <dt><label for="link">link:</label></dt>   
                                        <dd><input type="text" name="link" size="40" value="<?= $_SESSION['listPk']->link ?>"/>   
                                        </dd>   
                                    </dl>   
                                    <dl>    
                                         <?php    
                                                              if($_SESSION['listPk']->arquivo_logo);    
                                                              {   
                                                                   $filetype = pathinfo("../../upload/".$_SESSION['listPk']->arquivo_logo);   
                                                              ...
                                                              ?>    
                                                                   <dl>    
                                                                       <dt><label for="arquivo_logo">Arquivo:</label></dt>    
                                                                       <dd> <img width="310" src="../../upload/<?= $_SESSION['listPk']->arquivo_logo ?>"></dd>   
                                                                   </dl>    
                                                                   <dl>    
                                                                        <dt><input type="hidden" name="arquivo_logoOld" value="<?= $_SESSION['listPk']->arquivo_logo ?>" /></dt>   
                                                                       <dd><a href="../../controller/Parceiro.controller.php?id_parceiro=<?= $_SESSION['listPk']->id_parceiro ?>&opcao=deleteArquivo" class="ask"><img src="../../lib/images/trash.png" alt="" title="" border="0" /></a> Excluir Arquivo</dd>   
                                                                   </dl>    
                                                              <?php    
                                                                   }    
                                                                   else    
                                                              ...
                                                              ?>    
                                                                   <dl>    
                                                                       ...
                                                                       <dd> <?= $_SESSION['listPk']->arquivo_logo ?></dd>   
                                                                   </dl>    
                                                                   <dl>    
                                                                        <dt><input type="hidden" name="arquivo_logoOld" value="<?= $_SESSION['listPk']->arquivo_logo ?>" /></dt>   
                                                                       <dd><a href="../../controller/Parceiro.controller.php?id_parceiro=<?= $_SESSION['listPk']->id_parceiro ?>&opcao=deleteArquivo" class="ask"><img src="../../lib/images/trash.png" alt="" title="" border="0" /></a> Excluir Arquivo</dd>   
                                                              ...
                                                              ?>    
                                    <dl>   
                                        <dt><label for="arquivo_logo">arquivo_logo:</label></dt>   
                                        <dd><input type="file" name="arquivo_logo" size="40" value="<?= $_SESSION['listPk']->arquivo_logo ?>"/>   
                                        </dd>   
                                    </dl>   
                                    </dl>    
                                <dl class="submit">    
