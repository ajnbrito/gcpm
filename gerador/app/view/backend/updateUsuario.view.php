                        ...
                        <div class="form">   
                            <form action="../../controller/Usuario.controller.php" method="post" class="niceform" enctype="multipart/form-data">   
                                <fieldset>   
                                    ...
                                    <dl>   
                                        <dt></dt>   
                                        <dd><input type="hidden" name="id_usuario" id="id_usuario" value="<?= $_SESSION['listPk']->id_usuario ?>" /></dd>   
                                    </dl>   
                                    <dl>   
                                    ...
                                    <dl>   
                                        ...
                                        <dd><input type="text" name="usuario" size="40" value="<?= $_SESSION['listPk']->usuario ?>"/>   
                                        </dd>   
                                    </dl>   
                                    <dl>   
                                        <dt><label for="senha">senha:</label></dt>   
                                        <dd><input type="text" name="senha" size="40" value="<?= $_SESSION['listPk']->senha ?>"/>   
                                        </dd>   
                                    </dl>   
                                <dl class="submit">    
                                <dt><label></label></dt>    
